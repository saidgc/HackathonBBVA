...
@Component({
  selector: 'app-registra-persona-moral',
  templateUrl: './registra-persona-moral.component.html',
  styleUrls: ['./registra-persona-moral.component.css']
})
export class RegistraPersonaMoralComponent implements OnInit {
  rfc = 'paho';
  constructor () { }
